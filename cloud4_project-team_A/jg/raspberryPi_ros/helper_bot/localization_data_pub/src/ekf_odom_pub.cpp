...
const double TICKS_PER_REVOLUTION = 980; // For reference purposes.
const double WHEEL_RADIUS = 0.033; // Wheel radius in meters
const double WHEEL_BASE = 0.185; // Center of left tire to center of right tire
const double TICKS_PER_METER = 4900; // Original was 2800
